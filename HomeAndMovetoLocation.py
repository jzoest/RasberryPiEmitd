...
try:
    while cycle== True:
        ...
        if(gpio.input(z_axis_limit)!=0):
            print("Move out of stop end Z axis")
            for x in range(10):
                gpio.output(pulse_pin,gpio.HIGH)
                gpio.output(pulse_pin2,gpio.HIGH)
                sleep(.001)
